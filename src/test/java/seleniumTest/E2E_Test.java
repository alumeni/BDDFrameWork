...
//	public void i_fill_LastName_Field_with_my(String arg1) throws Throwable {

		driver.findElement(By.xpath("//input[@name='lastName']")).click();

		driver.findElement(By.xpath("//input[@name='lastName']")).clear();

		driver.findElement(By.xpath("//input[@name='lastName']")).sendKeys("Terra");

//	@When("^I create a valid Password with my \"([^\"]*)\"$")
//	public void i_create_a_valid_Password_with_my(String arg1) throws Throwable {
...
//	@Given("^I’m user on the “The Basic Page”$")
//	public void i_m_user_on_the_The_Basic_Page() throws Throwable {
...
//	@When("^fill the  Birthday Field with \"([^\"]*)\"$")
		// public void fill_the_Birthday_Field_with(String arg1) throws Throwable {
		driver.findElement(By.cssSelector("input#dateOfBirth")).click();

		driver.findElement(By.cssSelector("input#dateOfBirth")).sendKeys("11111111");

//	@When("^fill the  Zip code Field with \"([^\"]*)\"$")
//	public void fill_the_Zip_code_Field_with(String arg1) throws Throwable {
		driver.findElement(By.cssSelector("input#zipcode")).click();
		driver.findElement(By.cssSelector("input#zipcode")).sendKeys("10004");
